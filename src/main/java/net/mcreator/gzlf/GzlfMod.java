...
public class GzlfMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(GzlfMod.class);
	public static final String MODID = "gzlf";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing GzlfMod");
		GzlfModSounds.load();
		GzlfModTabs.load();

		GzlfModFeatures.load();

		GzlfModEntities.load();
		GzlfModBlocks.load();
		GzlfModBlockEntities.load();
		GzlfModItems.load();

		GzlfModDimensions.load();

		GzlfModVillagerProfessions.load();
		GzlfModTrades.registerTrades();
