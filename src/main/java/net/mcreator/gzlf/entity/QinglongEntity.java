...
public class QinglongEntity extends PathfinderMob {
	public QinglongEntity(EntityType<QinglongEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = QinglongEntity.this.getRandom();
				double dir_x = QinglongEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = QinglongEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = QinglongEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(GzlfModItems.MUSICDISCQINGLONG));
	}
