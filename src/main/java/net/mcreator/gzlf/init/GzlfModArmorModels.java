...
import net.mcreator.gzlf.client.renderer.item.SilverarmorArmor;
import net.mcreator.gzlf.client.renderer.item.JbyarmorArmor;
...
public class GzlfModArmorModels {
	...
	public static void clientLoad() {
		JbyarmorArmor.clientLoad();
		SilverarmorArmor.clientLoad();
	}
}